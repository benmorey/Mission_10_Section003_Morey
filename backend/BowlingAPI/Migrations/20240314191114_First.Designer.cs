...
namespace BowlingAPI.Migrations
{
    ...
    [Migration("20240314191114_First")]
    partial class First
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BowlingAPI.Models.BowlerScore", b =>
                {
            ...
            modelBuilder.Entity("BowlingAPI.Models.MatchGame", b =>
                {
                    b.Property<int>("MatchId")
                        .HasColumnType("INT")
                        .HasColumnName("MatchID");
            ...
            modelBuilder.Entity("BowlingAPI.Models.Tournament", b =>
                {
            ...
            modelBuilder.Entity("BowlingAPI.Models.TourneyMatch", b =>
                {
                    b.Property<int>("MatchId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INT")
            ...
            modelBuilder.Entity("BowlingAPI.Models.ZtblBowlerRating", b =>
                {
            ...
            modelBuilder.Entity("BowlingAPI.Models.ZtblSkipLabel", b =>
                {
            ...
            modelBuilder.Entity("BowlingAPI.Models.ZtblWeek", b =>
                {
            ...
            modelBuilder.Entity("BowlingAPI.Models.BowlerScore", b =>
                {
                    b.HasOne("BowlingAPI.Models.Bowler", "Bowler")
            ...
            modelBuilder.Entity("BowlingAPI.Models.MatchGame", b =>
                {
                    b.HasOne("BowlingAPI.Models.TourneyMatch", "Match")
                        .WithMany("MatchGames")
            ...
            modelBuilder.Entity("BowlingAPI.Models.TourneyMatch", b =>
                {
                    b.HasOne("BowlingAPI.Models.Team", "EvenLaneTeam")
                        .WithMany("TourneyMatchEvenLaneTeams")
                        .HasForeignKey("EvenLaneTeamId");

                    b.HasOne("BowlingAPI.Models.Team", "OddLaneTeam")
                        .WithMany("TourneyMatchOddLaneTeams")
                        .HasForeignKey("OddLaneTeamId");

                    b.HasOne("BowlingAPI.Models.Tournament", "Tourney")
